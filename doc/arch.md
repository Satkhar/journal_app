...
оруженосец, новичок, рекрут, гость, рыцарь. UI использует этот порядок для
сортировки и визуальной группировки.
...
тренировок. Unversioned legacy schema сначала мигрирует в v3, затем до v10:
...
удаляется, затем схема мигрирует через v7, v8, v9 до v10.
