...
- local schema v11 и транзакционные aggregate writes;
...
- карточки участников синхронизируются неполно; гербы, замеры ударов и турниры
  не синхронизируются;
...
- турниры и бои;
- гербы и будущие вложения через отдельный бинарный asset transport;
- замеры ударов.
